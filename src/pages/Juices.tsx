...
const juiceProducts: Product[] = [
  ...
  {
    id: 16,
    name: "REDBULL COCONUT EDITION  ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_coco.jpg",
  },
  {
    id: 17,
    name: "REDBULL SUMMER EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_summer.jpg",
  },
  {
    id: 18,
    name: "REDBULL ICE EDITION  ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_ice.jpg",
  },
  {
    id: 19,
    name: "REDBULL GREEN EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_green.jpg",
  },
  {
    id: 20,
    name: "REDBULL TROPICAL EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_yellow.jpg",
  },
  {
    id: 21,
    name: "REDBULL BLUE EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_blue.jpg",
  },
   {
    id: 22,
    name: "REDBULL BLUE EDITION ENERGY DRINK",
    ...
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_shot.jpg",
  },
  {
    id: 23,
    name: "REDBULL PINK EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_pink.jpg",
  },
  {
    id: 24,
    name: "REDBULL  APRICOT EDITION ENERGY DRINK",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_apricot.jpg",
  },
  {
    id: 25,
    name: "REDBULL  ENERGY DRINK 250",
    price: 299,
    size: "250ml",
    description: "Classic Red Bull energy drink",
    image: "/images/juices/redbull_250.jpg",
  },
  {
    id: 26,
    name: "MONSTER ENERGY",
  ...
  },
   {
    ...
    price: 299,
    size: "250ml",
    description: "BOOM BOOM energy drink",
    image: "/images/juices/boom.jpg",
  },
  {
    id: 28,
    name: "VIMTO",
    price: 299,
    size: "220ml",
    description: "VIMTO energy drink 1980",
    image: "/images/juices/vimto.jpg",
  },
  {
    id: 29,
    name: "SHANI FRUIT FLAVOURED DRINK",
    price: 220,
    size: "250ml",
    description: "SHANI FRUIT energy drink",
    image: "/images/juices/shani.jpg",
  },
];
