...
const features = [
  ...
  { icon: Truck, title: "Fresh Delivery", description: "Premium quality syrup delivered fresh" },
  { icon: Shield, title: "Quality Tested", description: "Lab-tested for purity and quality" },
  { icon: Award, title: "Premium Grade", description: "Only the finest date syrup" },
];

const healthBenefits = [
  { icon: Sparkles, title: "Natural Sweetener", description: "Healthy alternative to refined sugar" },
  { icon: Apple, title: "Rich in Nutrients", description: "Packed with vitamins and minerals" },
  { icon: Heart, title: "Heart Healthy", description: "Supports cardiovascular wellness" },
];
...
const DateSyrup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50/40 via-orange-50/20 to-white dark:from-slate-900 dark:to-slate-800">
      <Navbar />
      {/* Hero Section */}
      <section className="relative h-[500px] md:h-[600px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-800 via-orange-700 to-amber-900">
        ...
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center text-white max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 mb-6 border border-white/20">
              ...
              <span className="text-sm font-medium">100% Natural & Pure</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Premium date syrup - a natural, healthy alternative to refined sugar, packed with nutrients and rich flavor
            </p>
            <Button 
              size="lg" 
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
